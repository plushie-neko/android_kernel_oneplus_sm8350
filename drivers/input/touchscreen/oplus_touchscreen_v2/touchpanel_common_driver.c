...
static void __maybe_unused lcd_tp_load_fw(unsigned int tp_index)
{
	struct touchpanel_data *ts = NULL;
...
*/
static int __maybe_unused tp_control_reset_gpio(bool enable, unsigned int tp_index)
{
	struct touchpanel_data *ts = NULL;
...
*/
static void __maybe_unused tp_ftm_extra(unsigned int tp_index)
{
	struct touchpanel_data *ts = NULL;
...
static void __maybe_unused lcd_tp_refresh_switch(unsigned int tp_index, int fps)
{
	struct touchpanel_data *ts = NULL;
